 ...
 kal_uint32 charging_parameter_to_value(const kal_uint32 *parameter, const kal_uint32 array_size, const kal_uint32 val)
{
	...
	for(i=0;i<array_size;i++)
	{
		...
		battery_xlog_printk(BAT_LOG_CRTI, "Has register value match. val=%d---i=%d\r\n", val,i);
		return i;
		}
	}
...
static void hw_bc11_dump_register(void)
{
	...
	kal_uint32 reg_num = MT6325_CHR_CON18;//CHR_CON18;
	kal_uint32 i = 0;

	for(i=reg_num ; i<=MT6325_CHR_CON19 ; i+=2)//CHR_CON19
	{
 ...
 static void hw_bc11_init(void)
 {
	 ...
	 //RG_BC11_BIAS_EN=1	
	 mt6325_upmu_set_rg_bc11_bias_en(0x1);//upmu_set_rg_bc11_bias_en
	 //RG_BC11_VSRC_EN[1:0]=00
	 mt6325_upmu_set_rg_bc11_vsrc_en(0x0);//upmu_set_rg_bc11_vsrc_en
	 //RG_BC11_VREF_VTH = [1:0]=00
	 mt6325_upmu_set_rg_bc11_vref_vth(0x0);//upmu_set_rg_bc11_vref_vth
	 //RG_BC11_CMP_EN[1.0] = 00
	 mt6325_upmu_set_rg_bc11_cmp_en(0x0);//upmu_set_rg_bc11_cmp_en
	 //RG_BC11_IPU_EN[1.0] = 00
	 mt6325_upmu_set_rg_bc11_ipu_en(0x0);//upmu_set_rg_bc11_ipu_en
	 ...
	 mt6325_upmu_set_rg_bc11_bb_ctrl(0x1);
 	 ...
 	 msleep(10);//zhaochunlan modify for HQ00786957
 	 //mdelay(50);
 ...
 static U32 hw_bc11_DCD(void)
 {
	 ...
	 mt6325_upmu_set_rg_bc11_ipu_en(0x2);//upmu_set_rg_bc11_ipu_en
	 ...
	 msleep(20);//zhaochunlan modify for HQ00786957
	 //mdelay(80);
 ...
 static U32 hw_bc11_stepA1(void)
 {
	...
	//RG_BC11_IPD_EN[1:0] = 01
	mt6325_upmu_set_rg_bc11_ipd_en(0x1);//upmu_set_rg_bc11_ipd_en
	//RG_BC11_VREF_VTH[1:0]=00
	mt6325_upmu_set_rg_bc11_vref_vth(0x0);
	// RG_BC11_CMP_EN[1:0] = 01
	mt6325_upmu_set_rg_bc11_cmp_en(0x1);
 
	msleep(80);//zhaochunlan modify for HQ00786957
	//mdelay(80);
	...
	//RG_BC11_IPD_EN[1.0] = 00
	mt6325_upmu_set_rg_bc11_ipd_en(0x0);//upmu_set_rg_bc11_ipd_en
	//RG_BC11_CMP_EN[1.0] = 00
	mt6325_upmu_set_rg_bc11_cmp_en(0x0);
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    mt6325_upmu_set_rg_bc11_bb_ctrl(1);//	upmu_set_rg_bc11_bb_ctrl(1);    //BC11_BB_CTRL    
    mt6325_upmu_set_rg_bc11_rst(1); //  upmu_set_rg_bc11_rst(1);        //BC11_RST
    ...
    bq24296_set_vreg(0x35); //VREG 4.352V BATTERY_TEMP_CHARGING_CURRENT
#else
 ...
 //start for_runin tangqingcai modify
 extern int g_runin_battery_test_flag;
 //end for_runin tangqingcai modify
...
//start for_runin tangqingcai modify
	if(1 == g_runin_battery_test_flag)
	{
		battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] g_runin_battery_test_flag is Active, enable = %d !\r\n",enable);
	}
//end for_runin tangqingcai modify	
...
//start for_runin tangqingcai modify    	
    		if(1 == g_runin_battery_test_flag)
    		{
				...
				bq24296_set_en_hiz(0x1); // entry hiz mode	  
			}
			else
//end for_runin tangqingcai modify  			
			{
 ...
 static kal_uint32 charging_reset_watch_dog_timer(void *data)
 {
  ...
  static kal_uint32 charging_set_hv_threshold(void *data)
  {
	 ...
	 mt6325_upmu_set_rg_vcdt_hv_vth(register_value);//upmu_set_rg_vcdt_hv_vth
  ...
  static kal_uint32 charging_get_hv_status(void *data)
  {
	   ...
	   *(kal_bool*)(data) = mt6325_upmu_get_rgs_vcdt_hv_det();//upmu_get_rgs_vcdt_hv_det
 ...
 static kal_uint32 charging_get_battery_status(void *data)
 {
	   kal_uint32 status = STATUS_OK;
 	   ...
 	   mt6325_upmu_set_baton_tdet_en(1);	//upmu_set_baton_tdet_en
	   mt6325_upmu_set_rg_baton_en(1); //upmu_set_rg_baton_en
	   *(kal_bool*)(data) = mt6325_upmu_get_rgs_baton_undet();//upmu_get_rgs_baton_undet
 ...
 static kal_uint32 charging_get_charger_det_status(void *data)
 {
	   ...
	   *(kal_bool*)(data) = mt6325_upmu_get_rgs_chrdet();//upmu_get_rgs_chrdet
