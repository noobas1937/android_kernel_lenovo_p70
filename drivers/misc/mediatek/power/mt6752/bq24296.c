...
#define CHG_STATE_NO_CHARGING 0x00
#define CHG_STATE_PER_CHARGING 0x01
#define CHG_STATE_FAST_CHARGING 0x10
#define CHG_STATE_DONE_CHARGING 0x11


kal_uint8 bq24296_in_charging_state = 0;
kal_uint32 bq24296_in_charging(void)
{
    kal_uint32 ret=0;
    kal_uint8 val=0;
    val=bq24296_get_chrg_stat();
    
    if(val == CHG_STATE_NO_CHARGING)
        bq24296_in_charging_state=0;
    else
        bq24296_in_charging_state=1;

    printk("[bq24296_in_charging] bq24296_in_charging=%d, Reg[0x08]=0x%x\n", 
        bq24296_in_charging_state, val);
        return bq24296_in_charging_state;
}
